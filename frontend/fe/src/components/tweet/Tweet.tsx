...
import DeleteTweetModal from "../modal/DeleteTweetModal";
        ...
        <>
            <div className="border-b border-gray-200 px-4 py-3 space-y-3">
                ...
                <div className="flex justify-between ml-8">
                    ...
                    {tweet.retweets ? (
                        <>
                            {(tweet.retweets.filter(ret => ret.user_id === currentUser?.id).length > 0) ? (
                                <div
                    ...
                    {tweet.favorites ? (
                        <>
                            {(tweet.favorites.filter(fav => fav.user_id === currentUser?.id).length > 0) ? (
                    ...
                    {(tweet.bookmarks && tweet.bookmarks.filter(book => book.user_id === currentUser?.id).length > 0) ? (
